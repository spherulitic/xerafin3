<?php
	include ($_SERVER['DOCUMENT_ROOT']."/PHP/styling.gradients.php");
...
?>
<?php
	//Code Specific Variables, will become a JSON file at a later date //

	$textColor = "black";
	$textColorLight = "rgba(240,240,213,1)";
	$textColorGrey = "rgba(197,197,197,1)";
	$fontMain = "'Montserrat', sans-serif";
	$fontSecond = "'Lato', sans-serif";
	$xeraGreen = "rgba(128,164,48,1)";
	$xeraSubHover = "rgba(64,144,200,1)";

?>
<?php echo CSSLinearGradientFill ("darkSteelRowed", [['#666666','0%'],['#868686','50%'],['#666666','100%']],true); ?>
<?php echo CSSLinearGradientFill ("burntOrangeRowed", [['#ee6600','0%'],['#dd5c00','50%'],['#ee6600','100%']],true); ?>
<?php echo CSSLinearGradientFill ("highlightRow", [['rgba(128,164,48,0.95)','0%'],['rgba(140,176,48,0.95)','50%'],['rgba(128,164,48,0.95)','100%']],true); ?>
<?php echo CSSLinearGradientFill ("blueRowed", [['rgba(48,128,186,0.95)','0%'],['rgba(64,144,200,0.95)','50%'],['rgba(48,128,186,0.95)','100%']],true); ?>
...
.overviewButton {
	...
	/*font-family: <?php echo $fontSecond; ?>;*/
...
.overviewItem:hover {box-shadow:0 0 5px <?php echo $xeraGreen; ?>,0 0 5px <?php echo $xeraGreen; ?>;}
.overviewItemSub {}
.overviewItemSub:hover {box-shadow:0 0 5px <?php echo $xeraSubHover; ?>,0 0 5px <?php echo $xeraSubHover; ?> !important;}
...
/*.xeraSelectDropdownChild:hover:after {
	background-color: <?php echo $xeraGreen; ?>;
	color: <?php echo $textColor; ?>;
	border: 1px solid black;
}*/
.xeraSelectDropdown {
...
.xeraTabButtons:hover {
	box-shadow:0 0 5px <?php echo $xeraGreen; ?>,0 0 5px <?php echo $xeraGreen; ?>;
}
...
.subscribeButton:hover {box-shadow:0 0 5px <?php echo $xeraGreen; ?>,0 0 5px <?php echo $xeraGreen; ?>;}
...
.loginHead {
	text-align:left;
	border-bottom:1px solid <?php echo $textColorLight; ?>;
	font-variant:small-caps;
	width:100%;
	color: <?php echo $textColorLight; ?>;
	margin-bottom:5px;
