...
def getNavbar():
  ...
  contents = [
    ...
    {'title': 'Cardbox Invaders', 'onClick': 'overview.setGoAction({context:"MY",value:2});overviewUI.update("MY_GO_SET_DEFAULT",2);overviewUI.update("SEARCH_GO_SET_DEFAULT",2);overview.go("MY");', 'hasChildren': False, 'privLevel': 1, 'lastChild': False, 'new': True},
